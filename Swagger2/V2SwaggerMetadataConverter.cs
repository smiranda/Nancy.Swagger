...
{
    [SwaggerApi]
    public class V2SwaggerMetadataConverter : ISwaggerMetadataConverter
    {
        private ISwaggerMetadataProvider _metadataProvider;

        public V2SwaggerMetadataConverter(ISwaggerMetadataProvider metadataProvider)
        {
        ...
        {
            var apiDocumentation = new ApiDocumentation { Version = "2.0", Host = "localhost" };
